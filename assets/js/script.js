...
function buildTumblr() {
	var k = "acuLe1biarLEFJyW5Q1wiJoGcYlFFSCPqccVI9oJ3eOmBpvgBc";
	if ($("#tumblrBlog").length > 0) {
		$.ajax({
			dataType: "jsonp",
			url: "https://api.tumblr.com/v2/blog/blog.annamcilwraith.com/posts?tag=blog&api_key=" + k,
